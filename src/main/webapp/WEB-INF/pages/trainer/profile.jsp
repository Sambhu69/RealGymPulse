...
<main class="flex-grow max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 pb-36">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div class="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-8 backdrop-blur-xl shadow-2xl relative overflow-hidden group">
            ...
            <form action="${pageContext.request.contextPath}/trainer/profile" method="POST" enctype="multipart/form-data" class="space-y-5 relative z-10">
        ...
        <div class="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-8 backdrop-blur-xl shadow-2xl relative overflow-hidden group">
            ...
            <form action="${pageContext.request.contextPath}/trainer/profile" method="POST" id="passwordForm" onsubmit="return validatePasswords()" class="space-y-5 relative z-10">
